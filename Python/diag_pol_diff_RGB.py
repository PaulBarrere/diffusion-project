"""
La routine diag_pol_diff_RGB.py affiche les diagrammes polaires
...
data1=open('Data/rayl_diff_R.dat','r')
data2=open('Data/rayl_diff_G.dat','r')
data3=open('Data/rayl_diff_B.dat','r')
...
def diag_pol(data_list):
    ...
    for i in range(0,len(data_list)):
        ...
        diag_pol[:,0]=-tab[:,1]*(tab_nb[0,i]/tab_nb[0,-1])*np.cos(tab[:,2])
        diag_pol[:,1]=tab[:,1]*(tab_nb[0,i]/tab_nb[0,-1])*np.sin(tab[:,2])
